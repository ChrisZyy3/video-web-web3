export default {
  ...
  mine: {
    ...
    browserPromptTitle: '获得更好的观看体验',
    browserPromptContent: '检测到你已是会员。在系统浏览器中打开本站，播放更流畅、更稳定。是否前往？',
    goToBrowser: '前往浏览器',
    stayHere: '留在这里',
    browserLinkCopied: '链接已复制，请打开浏览器粘贴访问',
  ...
  tronPay: {
    ...
    trxSignTimeout: 'TRX 支付响应超时。若已在钱包确认，请稍候再点支付',
